    ...
    <div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="row w-100 m-0">
          <div  style="background:url({{ asset('/manager/assets/images/auth/lockscreen-bg.jpg') }}) !important ; background-size:cover !important" class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
