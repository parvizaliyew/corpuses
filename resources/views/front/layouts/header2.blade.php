        ...
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav m-auto py-4">
                    <a href="{{ route('index') }}" class="nav-item nav-link  ">Əsas Səhifə</a>
                    <a href="{{ route('about') }}" class="nav-item nav-link {{ Route::is('about') ? 'active' : null }} ">Haqqımızda</a>
                    <a href="{{ route('korpus') }}" class="nav-item nav-link {{ Route::is('korpus') ? 'active' : null }}">Korpuslar</a>                 
                    <a href="{{ route('contact') }}" class="nav-item nav-link {{ Route::is('contact') ? 'active' : null }}">Əlaqə</a>
