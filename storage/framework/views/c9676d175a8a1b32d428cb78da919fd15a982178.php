                ...
                <div class="row">
                    <div style="margin: auto" class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="<?php echo e(route('korpus')); ?>"><i class="fa fa-angle-right mr-2"></i>Korpuslar</a>
                            <a class="text-white" href="<?php echo e(route('contact')); ?>"><i class="fa fa-angle-right mr-2"></i>Əlaqə</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex justify-content-start mt-4">
                            <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo e($setting->tw); ?>"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo e($setting->fb); ?>"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo e($setting->ln); ?>"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo e($setting->ins); ?>"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
